...
# O método execute permite a execução de uma query SQL
        self.cursor.execute(
            ...
            " OPCAO_PLANO_SAUDE, MUNICIPIO_NASCIMENTO, TIPO_CONTA, cor, grau_instrucao, cpf, pis,admissao, venc_ferias,"
            "vinculo, categoria, sindicalizado, salario, ini_praz_det, fim_praz_det, pro_praz_det, cart_prof,"
            "serie_cart_prof, dt_exp_cprof, uf_cart_prof, num_cart_ponto, horas_mes, horas_semana,horas_dia,"
            " forma_pagto,  conta_corr, PLANO_SAUDE_OPTANTES, identidade, org_exp_ident, uf_exp_ident, dt_exp_ident,"
            " NUMERO_PASSAPORTE, EMISSOR_PASSAPORTE,UF_PASSAPORTE, DATA_EMISSAO_PASSAPORTE, DATA_VALIDADE_PASSAPORTE,"
            " titulo_eleit, zona_eleit, secao_eleit, cart_motorista, categ_cart_mot, ORGAO_EMISSOR_CNH,"
            " DATA_EXPEDICAO_CNH, estado, cart_reservista,cate_reservista, venc_cart_mot, ENDERECO_COMERCIAL,"
            " cep, TIPO_ENDERECO, endereco, RESIDENTE_EXTERIOR, numero_end, complemento, bairro, RESIDENCIA_PROPRIA,"
            " IMOVEL_ADQUIRIDO_RECURSOS_FGTS,EMAIL_ALTERNATIVO, EMAIL, fone, fone2, data_nascimento,uf_nascimento,"
            "naturalizado, DATA_NATURALIZACAO, ALVARA_JUDICIAL, NUMERO_ALVARA, nome_mae, nome_pai, nome_conjuge, sexo,"
            " estado_civil, grupo_sanguineo, rh_sanguineo,  CASADO_BRASILEIRO, POSSUI_DEFICIENCIA,"
            " POSSUI_DEFICIENCIA_MOTORA, deficiente_fisico, POSSUI_DEFICIENCIA_VISUAL, POSSUI_DEFICIENCIA_AUDITIVA,"
            " POSSUI_DEFICIENCIA_OUTRAS, POSSUI_DEFICIENCIA_REABILITADO, OBSERVACAO_DEFICIENCIA,"
